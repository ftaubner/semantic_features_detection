...
class InteriorDataset(utils.Dataset):
    def load_Interior(self, dataset_dir, class_ids=None):
    ...
    def image_reference(self, image_id):
        """Return a link to the website of the InteriorNet data."""
        
        info = self.image_info[image_id]
        if info["source"] == "InteriorNet":
            return info["path"]
        else:
    ...
    def load_mask(self, image_id):
        ...
        if image_info["source"] != "InteriorNet":
