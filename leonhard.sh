...
unzip -qq $TMPDIR/mapillary_vistas_sample.zip -d /scratch

# run mapillary.py script
python3 samples/mapillary/mapillary.py train --dataset=$TMPDIR/mapillary_vistas/ --model=coco --logs=/cluster/scratch/erbachj/semantic_features/logs