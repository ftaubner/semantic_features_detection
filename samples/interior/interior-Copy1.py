...
class InteriorDataset(utils.Dataset):
    def load_Interior(self, dataset_dir, class_ids=None, return_coco=False):
        ...
        coco = COCO("{}/cocolabel.json".format(dataset_dir))
    ...
    def load_mask(self, image_id):
        ...
        for annotation in annotations:
            ...
            if class_id:
                m = imageio.imread("{}/label0/data/{}_instance.png".format(self.dataset_dir, annotation['mask_image_id']))
